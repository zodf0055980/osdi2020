...
int register_filesystem(struct filesystem *fs)
{
    ...
    else if (strcmp(fs->name, "fat32") != 0)
    {
        ...
        fat32fs_v_ops = (struct vnode_operations *)fix_object_array[varied_size_alloc(sizeof(struct vnode_operations))].obj;
        fat32fs_f_ops = (struct file_operations *)fix_object_array[varied_size_alloc(sizeof(struct file_operations))].obj;

        tmpfs_v_ops->lookup = lookup_fat32;
        tmpfs_v_ops->create = create_fat32;
        tmpfs_f_ops->write = write_fat32;
        tmpfs_f_ops->read = read_fat32;
